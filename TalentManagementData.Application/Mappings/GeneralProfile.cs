using TalentManagementData.Application.Features.Departments.Commands.CreateDepartment;
using TalentManagementData.Application.Features.Employees.Commands.CreateEmployee;
using TalentManagementData.Application.Features.Positions.DTOs;
using TalentManagementData.Application.Features.SalaryRanges.Commands.CreateSalaryRange;
using TalentManagementData.Domain.ValueObjects;

namespace TalentManagementData.Application.Mappings
{
