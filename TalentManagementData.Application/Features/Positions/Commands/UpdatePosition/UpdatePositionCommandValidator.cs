namespace TalentManagementData.Application.Features.Positions.Commands.CreatePosition
{
    ...
    public class UpdatePositionCommandValidator : AbstractValidator<UpdatePositionCommand>
    {
        ...
        public UpdatePositionCommandValidator(IPositionRepositoryAsync repository)
        {
            ...
            // Rule to validate that PositionTitle is not empty, null and does not exceed 250 characters.
            RuleFor(p => p.PositionTitle)
                ...
                .MaximumLength(250).WithMessage("{PropertyName} must not exceed 250 characters."); // Validates that the PositionTitle property does not exceed 250 characters
        }
    }
}
