...
using TalentManagementData.WebApi.Filters;
using TalentManagementData.WebApi.Options;

namespace TalentManagementData.WebApi.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            services.AddOpenApiDocument(config =>
            {
                ...
                config.Version = "v1";
                config.Title = "Clean Architecture - TalentManagementData.WebApi";
